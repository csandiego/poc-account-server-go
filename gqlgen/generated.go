...
type QueryResolver interface {
	UserProfile(ctx context.Context, userID int) (*data.UserProfile, error)
}
...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "schema.graphql", Input: `type UserProfile {
  userId: Int!
  firstName: String!
  lastName: String!
}
...
func (ec *executionContext) _Query_userProfile(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().UserProfile(rctx, args["userId"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*data.UserProfile)
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNUserProfile2ᚖgithubᚗcomᚋcsandiegoᚋpocᚑaccountᚑserverᚋdataᚐUserProfile(ctx, field.Selections, res)
}
...
func (ec *executionContext) _UserProfile_userId(ctx context.Context, field graphql.CollectedField, obj *data.UserProfile) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _UserProfile_firstName(ctx context.Context, field graphql.CollectedField, obj *data.UserProfile) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _UserProfile_lastName(ctx context.Context, field graphql.CollectedField, obj *data.UserProfile) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _UserProfile(ctx context.Context, sel ast.SelectionSet, obj *data.UserProfile) graphql.Marshaler {
...
func (ec *executionContext) marshalNUserProfile2githubᚗcomᚋcsandiegoᚋpocᚑaccountᚑserverᚋdataᚐUserProfile(ctx context.Context, sel ast.SelectionSet, v data.UserProfile) graphql.Marshaler {
	return ec._UserProfile(ctx, sel, &v)
}

func (ec *executionContext) marshalNUserProfile2ᚖgithubᚗcomᚋcsandiegoᚋpocᚑaccountᚑserverᚋdataᚐUserProfile(ctx context.Context, sel ast.SelectionSet, v *data.UserProfile) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
